...
import type { LanguagePreferenceResult } from '@/types/languagePreference'
...
import SyncScoreSection from './sections/SyncScoreSection.vue'
...
<template>
  <div class="main-content mx-auto max-w-[920px] py-6">
    ...
    <template v-else-if="data">
      ...
      <!-- Section 5: 共同词汇 -->
      <SyncScoreSection :shared-words="data.sharedWords" class="mt-6" @word-click="handleWordClick" />
    </template>
  </div>
</template>
